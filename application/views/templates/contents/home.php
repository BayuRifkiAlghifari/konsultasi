						...
						<div class="carousel slide" data-ride="carousel">
						  	<div class="carousel-inner">
						    	...
						    	<div class="item active">
						      		<img style="width: 100%; height: 450px;" src="https://2.bp.blogspot.com/-Uskxbx5SVRA/WmPeb614cWI/AAAAAAAABag/I7YOYO9RndUC_waLCJqtsPaagYUGQ3x9gCLcBGAs/s1600/ts-holder-1.png" alt="Demo 1">
						    	...
						    	<div class="item">
						      		<img style="width: 100%; height: 450px;" src="https://1.bp.blogspot.com/-grnESdXufh0/WmPebw5hnqI/AAAAAAAABao/14ayf_GP5xYmLK2Zs0axN0JGIOevWFB2QCLcBGAs/s1600/ts-holder-2.png" alt="Demo 2">
						      		<div class="carousel-caption">
								      	<h3>Caption Text</h3>
								    </div>
						    	</div>
						    	...
						    	<div class="item">
						      		<img style="width: 100%; height: 450px;" src="https://3.bp.blogspot.com/-R9nLK8bxp6E/WmPebnN9FwI/AAAAAAAABak/0h_rVaQ7XDIGSTKKrNUU60F6BctsmxuFQCLcBGAs/s1600/ts-holder-3.png" alt="Demo 3">
						      		<div class="carousel-caption">
								      	<h3>Caption Text</h3>
								    </div>
						    	</div>
							...
							<div class="well well-light">
								<div class="who clearfix">
									<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
										<h4><i class="fa fa-fw fa-lg fa-medkit"></i> JUMLAH DOKTER</h4>
									</div>
									<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
										<h4><i class="fa fa-fw fa-lg fa-users"></i> JUMLAH PENGGUNA</h4>
									</div>
								</div>
								<div class="text">
									<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
