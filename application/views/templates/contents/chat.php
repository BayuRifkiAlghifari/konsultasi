															...
															<div class="panel-body no-padding text-align-center">
																...
																<div class="price-features">
																	<ul class="list-unstyled text-left">
																		...
																		<li><i class="fa fa-check text-success"></i> <strong>Durasi : <?= $p['durasi']; ?> Hari</strong></strong></li>
																	</ul>
																</div>
															</div>
															<div class="panel-footer text-align-center">
																<a href="<?= base_url('langganan/') . $p['id_program']; ?>" class="btn btn-primary btn-block" role="button">Langganan Sekarang</a>
															</div>
														</div>
													</div>
												<?php endforeach; ?>
